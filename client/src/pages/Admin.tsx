    ...
    <div className="space-y-6">
      ...
      <div className="glass rounded-xl p-6">
        <div className="flex flex-col md:flex-row items-start md:items-center justify-between">
          <div>
            <h3 className="text-2xl font-display font-semibold mb-2">Welcome back, Swati!</h3>
            <p className="text-gray-300">
              Here's what's happening with your website today.
            </p>
          </div>
          <div className="mt-4 md:mt-0">
            <button className="btn-glow bg-gradient-to-r from-[hsl(var(--accent-purple))] to-[hsl(var(--accent-blue))] px-5 py-2 rounded-lg font-medium hover:shadow-lg transition-all">
              View Website
            </button>
          </div>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
        {[
          { label: "Website Visits", value: "2,547", change: "+12.5%", isPositive: true },
          { label: "New Inquiries", value: "17", change: "+5", isPositive: true },
          { label: "Upcoming Events", value: "8", change: "2 this week", isPositive: null },
          { label: "Most Viewed", value: "Wedding Planning", change: "32% of traffic", isPositive: null },
        ].map((stat, index) => (
          <div key={index} className="glass rounded-xl p-6">
            ...
            <div className="flex items-end justify-between">
              ...
              <p className={`text-sm ${stat.isPositive === true ? 'text-green-400' : stat.isPositive === false ? 'text-red-400' : 'text-gray-400'}`}>
                {stat.change}
              </p>
            </div>
          </div>
